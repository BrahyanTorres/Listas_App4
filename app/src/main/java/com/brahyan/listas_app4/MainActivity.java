package com.brahyan.listas_app4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ultimoMensaje ={
                "Oe", "Todo Bien","Nos vemos hoy?","Que golazo Crack","Wie heist du?","Gogga Bonito"
        };
        ...
        String[] pais ={
                "Colombia", "Portugal","Argentina","Colombia","Inglaterra","Brasil"
        };
